# feature-first-frontend-architecture Specification

## Purpose
Define the frontend source layout, dependency direction, migration compatibility, and colocated testing expectations for Gitano's feature-first React architecture.
