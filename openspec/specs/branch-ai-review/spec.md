...
Define local AI branch review behavior for actionable changed-code findings, changed-line anchors, draft feedback controls, and local non-mutating execution.
