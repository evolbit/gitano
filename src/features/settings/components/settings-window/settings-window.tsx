            ...
            <div className="mx-auto w-full max-w-[780px]">
              ...
              {pane === "models" ? (
                <ModelsPane
                  catalog={catalog}
                  entitlement={entitlement}
                  externalEngineSelected={externalEngineSelected}
                  modelStatuses={modelStatuses}
                  modelUsageById={modelUsageById}
                  setupInProgress={setupInProgress}
                  warmModelIds={warmModelIds}
                  warmSavingModelIds={warmSavingModelIds}
              ...
              {pane === "configuration" ? (
                <ConfigurationPane
                  catalog={catalog}
                  externalAgents={externalAgents}
                  externalConfigByAgentId={externalConfigByAgentId}
                  externalConfigErrorsByAgentId={externalConfigErrorsByAgentId}
                  externalConfigLoadingByAgentId={externalConfigLoadingByAgentId}
                  modelStatuses={modelStatuses}
                  preferences={preferences}
                  promptDrafts={promptDrafts}
                  promptSavingActionKinds={promptSavingActionKinds}
                  setPromptDrafts={setPromptDrafts}
                  setupInProgress={setupInProgress}
                  warmModelIds={warmModelIds}
                  warmSavingModelIds={warmSavingModelIds}
                  onSetActionPromptOverride={handleSetActionPromptOverride}
