...
export type DiffModalProps = {
  ...
  repoPath?: string;
  sha?: string;
  changesViewMode?: import("@/features/working-changes/changes-explorer/types").ChangesExplorerViewMode;
  onChangesViewModeChange?: (
    mode: import("@/features/working-changes/changes-explorer/types").ChangesExplorerViewMode,
  ) => void;
