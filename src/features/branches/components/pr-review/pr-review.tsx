...
import { BranchAiErrorDetails } from "../branch-compare/branch-ai-error-details";

export type PrReviewProps = {
  repoPath: string;
  pullRequestContext: {
...
function pullRequestListItemFromContext(
  context: PrReviewProps["pullRequestContext"],
): PullRequestListItem {
...
export function PrReview({
  ...
  const comparisonMode = "mergeBase" as const;
