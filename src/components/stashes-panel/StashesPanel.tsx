...
import { ChangesExplorerFileRow } from "../changes-explorer/ChangesExplorerFileRow";
import { ChangesExplorerTreeNodes } from "../changes-explorer/ChangesExplorerTreeNodes";
import {
  ChangesExplorerCheckboxState,
  getFolderCheckboxState as computeFolderCheckboxState,
} from "../changes-explorer/utils";
import {
  IconBinaryTree2,
  IconDotsVertical,
  IconLayoutList,
...
function toChangesExplorerFile(file: StashFileChange): ChangesExplorerFile {
  return {
    path: file.path,
